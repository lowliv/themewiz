...
def enter_settings():
    ...
    if value == "Border Width":
        ...
        if sub_value == "Bar Border Width\n":
            border_width  = questionary.text("Enter bar border width in pixels:",default=border_width,validate=is_integer).ask()
            data['border_width'] = border_width
        if sub_value == "Back":
            enter_settings()
    if value == "Opacity":
    ...
    if value == "Rounding":
        ...
        if sub_value == "Rounding":
            border_width  = questionary.text("Enter rounding value in pixels:",validate=is_integer).ask()
            data['rounding'] = rounding
        if sub_value == "Bar Rounding\n":
            border_width  = questionary.text("Enter bar rounding value in pixels:",default=rounding,validate=is_integer).ask()
